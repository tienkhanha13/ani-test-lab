...
class Controller_Login
{
    ...
    public function count_login()
    {
      ...
      $model->update_count_login_day(date("Y-m-d"));
      $model->update_count_login_month(date("Y-m-01"));
    }
    /**
    ...
    public function submit_password()
    {
        ...
        if (isset($_SESSION['username'])) {
            ...
            if ($password == $user->password) {
                $result['status_value'] = "Đăng nhập thành công!";
                $result['status'] = 1;
