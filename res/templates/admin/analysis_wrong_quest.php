								    ...
								    <div class="card-block">
								        ...
								        <div class="row">
								            <div class="col-sm-12 pt-3 pb-3 border-top">
								                <span class="mr-3"><i class="feather icon-disc text-c-green  mr-2"></i>Trả lời đúng</span>
								                <span class="float-right"><?=$analysis[0]->correct?> %</span>
								            </div>

								            <div class="col-sm-12 pt-3 pb-3 border-top">
								                <span class="mr-3"><i class="feather icon-disc text-c-blue  mr-2"></i>Trả lời sai</span>
								                <span class="float-right"><?=$analysis[0]->incorrect?> %</span>
								            </div>

								            <div class="col-sm-12 pt-3 border-top">
								                <span class="mr-3"><i class="feather icon-disc text-c-purple  mr-2"></i>Không có câu trả lời</span>
