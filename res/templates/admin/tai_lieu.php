                ...
                <div class="card-body">
                    <ul>
											...
											for ($i=0; $i < count($document); $i++) {
													echo '<li id="'.$document[$i]->id.'" class="doc_hover" ><a href="upload/document/'.$document[$i]->doc_path.'" >'.$document[$i]->doc_name.'</a><span> ('.$document[$i]->note.')</span><a style="color:red;margin-left: 10px;" href="#!" onclick="del_document('.$document[$i]->id.')">xóa</a></li>';
											}
											 ?>
                    </ul>
                </div>
...
<div id="loading-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="loading-modal-label" aria-hidden="true">
		<div class="modal-dialog" role="document">
				<div class="modal-content">
						<div class="modal-header">
								<h5 class="modal-title" id="loading-modal-label">Đang tải lên</h5>
