									...
									<div class="card">
										<div class="row">
											<div class="col-md-6 col-sm-12" style="padding: 30px 50px 30px 50px;height: 680px;overflow: auto;">
												<div id="teacher_content" class="row">
												</div>
											</div>
											<div class="col-md-6 col-sm-12" style="padding: 30px 50px 30px 50px;height: 680px;overflow: auto;">
								...
								<form id="send_notification">
										...
										<div class="row">
											<div class="col-6">
												...
												<button type="button" class="btn btn-sm btn-primary   m-b-10" id="select-all-teacher">Chọn hết</button>
												<button type="button" class="btn btn-sm btn-primary   m-b-10" id="deselect-all-teacher">Bỏ hết</button>
												<select name="teacher_id" id="teacher_id" class="searchable" multiple="multiple">
												<?php
