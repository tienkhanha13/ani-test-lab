        ...
        <ul class="nav pcoded-inner-navbar">
          ...
          <li class="nav-item pcoded-hasmenu">
              ...
              <ul class="pcoded-submenu">
                ...
                <li data-name="cau-hoi-chon-sai" class="nav-item"><a href="cau-hoi-chon-sai" class="nav-link"><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Câu hỏi chọn đúng</span></a></li>
          ...
          <li class="nav-item pcoded-hasmenu">
              <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-package"></i></span><span class="pcoded-mtext">Quản lý chung</span></a>
              <ul class="pcoded-submenu">
                <li data-name="admin" class="nav-item"><a href="quan-ly-admin" class="nav-link"><span class="pcoded-micon"><i class="fas fa-users-cog"></i></span><span class="pcoded-mtext">Quản lý chuyên môn</span></a></li>
                <li data-name="giao-vien" class="nav-item"><a href="quan-ly-giao-vien" class="nav-link"><span class="pcoded-micon"><i class="fas fa-user-tie"></i></span><span class="pcoded-mtext">Giáo viên</span></a></li>
                <li data-name="lop" class="nav-item"><a href="quan-ly-lop" class="nav-link"><span class="pcoded-micon"><i class="fas fa-users"></i></span><span class="pcoded-mtext">Lớp</span></a></li>
                <li data-name="hoc-sinh" class="nav-item"><a href="quan-ly-hoc-sinh" class="nav-link"><span class="pcoded-micon"><i class="fas fa-user-graduate"></i></span><span class="pcoded-mtext">Học Sinh</span></a></li>
          <li data-name="mon-hoc" class="nav-item"><a href="quan-ly-mon-hoc" class="nav-link"><span class="pcoded-micon"><i class="fas fa-book"></i></span><span class="pcoded-mtext">Môn học</span></a></li>
              </ul>
          </li>
          <li class="nav-item pcoded-hasmenu">
              <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-folder"></i></span><span class="pcoded-mtext">Quản lý đề</span></a>
              <ul class="pcoded-submenu">
                ...
                <li data-name="to-chuc-khao-sat" class="nav-item"><a href="quan-ly-de-khao-sat" class="nav-link"><span class="pcoded-micon"><i class="fas fa-sitemap"></i></span><span class="pcoded-mtext">Kho đề khảo sát</span></a></li>
  ...
  <header class="navbar pcoded-header navbar-expand-lg navbar-light">
    ...
    <div class="collapse navbar-collapse">
      ...
      <ul class="navbar-nav ml-auto">
        <li>
            <a href="gui-thong-bao"><i class="icon feather icon-bell"></i></a>
        </li>
        ...
        <li>
          <div class="dropdown drp-user">
            ...
            <div class="dropdown-menu dropdown-menu-right profile-notification">
              ...
              <ul class="pro-body">
                <li><a href="cai-dat" class="dropdown-item"><i class="feather icon-settings"></i>Cài đặt</a></li>
